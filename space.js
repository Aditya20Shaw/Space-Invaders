...
let shipImg;
let shipVelocityX = titleSize; //ship moving speed
...
function update() {
    ...
    //clear bullets
     ...
     if(alienCount == 0) {
        ...
        alienColumns = Math.min(alienColumns + 1, columns/2 -2); //cap at 16/2 =6
        alienRows = Math.min(alienRows + 1, rows-4); //cap at 16-4 = 12
        alienVelocityX += 0.2;//increase the align movement speed
        alienArray = [];
        bulletArray = [];
        createAliens();
     }
